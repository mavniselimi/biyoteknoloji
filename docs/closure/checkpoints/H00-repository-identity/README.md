# H00-repository-identity - repository identity and baseline

**Status: PENDING_REVIEW.** Nothing in this package is approved.

A baseline commit, tree and tag now exist and are measured. What is open is whether they are the ones this project meant, and where - if anywhere - this repository is published.
...
| Cannot be decided by | a maintainer acting alone; the identity is written into history |
