...
from pgx.domain.authority import (AUTHORITY_VOCABULARY_VERSION,
...
#: Re-exported from :mod:`pgx.domain.authority`, which is where the vocabulary
#: now lives. It moved there because the rules and curation layers need it and
#: their boundary tests refuse an import of this package - correctly, since a
#: reporting module is not something a domain layer may depend on. Callers that
